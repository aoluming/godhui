...
train_data = DataLoader(
    EmotionDataset(opt.train_img_path, txt_path='train.txt', img_size=opt.img_size,
...
vaild_data = DataLoader(
    EmotionDataset(opt.vaild_img_path, txt_path='test.txt', img_size=opt.img_size, face_size=opt.face_size),
    batch_size=opt.batch_size,
    pin_memory=True,
    shuffle=True,
    drop_last=True,
